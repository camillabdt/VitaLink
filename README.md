...
| 5. Verificação de segurança | CI atual verde; revisão HITL e DAST do VitaLink pendentes                  | [Verificação de segurança](docs/implementacao-segura/etapa5-verificacao-de-seguranca.md), [evidências das issues #50 a #66](docs/implementacao-segura/README.md)                                                                                                                                                |
