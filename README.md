...
| Implementação               | Primeira versão executável; gate final do HEAD atual pendente               | [Implementação segura](docs/implementacao-segura/README.md), [`VitaLink Health Management App/`](VitaLink%20Health%20Management%20App/)                                                                                                                                                                         |
...
| 5. Verificação de segurança | Testes existentes; suíte local atual com falhas e DAST do VitaLink pendente | [Verificação de segurança](docs/implementacao-segura/etapa5-verificacao-de-seguranca.md), [evidências das issues #50 a #66](docs/implementacao-segura/README.md)                                                                                                                                                |
