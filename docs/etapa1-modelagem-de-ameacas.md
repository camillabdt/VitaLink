...
| CA05 | Alteração maliciosa de exame          | Ator cria ou altera informação clínica sem autorização.                  | T07, T15      | [Integridade](casos-de-abuso-integridade.md)                     |
| CA06 | Exclusão de registro                  | Ator remove dado ou referência para ocultar ação ou causar perda.        | T08, T09, T15 | [Integridade](casos-de-abuso-integridade.md)                     |
...
| CA09 | Sobrecarga da API                     | Ator envia requisições para impedir uso legítimo.                        | T13           | [Catálogo](casos-de-abuso.md#ca09--sobrecarga-da-api)            |
| CA10 | Esgotamento do armazenamento          | Ator envia arquivos para esgotar capacidade.                             | T14           | [Catálogo](casos-de-abuso.md#ca10--esgotamento-do-armazenamento) |
