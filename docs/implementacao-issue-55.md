...
O paciente consulta pendências, seleciona categorias e operações, informa prazo e TOTP, concede ou recusa e visualiza “Compartilhado com” a partir da API. O profissional solicita acesso por código, pesquisa e filtra apenas cartões autorizados e abre um detalhe novamente validado pela API. Dados clínicos e controles ainda não implementados não aparecem nessa rota.
