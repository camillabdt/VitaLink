...
| RS07 | O compartilhamento por link deve utilizar identificador imprevisível, validade limitada, revogação, mediação pela API e registro de cada utilização, sem expor diretamente o armazenamento. | T10, R10 |
...
| V07 | Link previsível, permanente, não revogável ou que permita acesso direto ao armazenamento. | RS07 | T10 |
...
| DA07 | Implementar compartilhamento como uma credencial de capacidade temporária e revogável validada pela API, sem fornecer URL direta do armazenamento. | RS07, V07, T10 | Link expirado ou revogado deve ser negado; acesso válido deve ser auditado e restrito ao recurso compartilhado. |
