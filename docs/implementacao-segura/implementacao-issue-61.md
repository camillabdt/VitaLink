...
A aba profissional usa o rótulo “Valores de Referência”. Esse rótulo é apenas uma escolha de interface: os registros continuam sendo metas/faixas clínicas definidas por profissional, com autoria e versionamento. Eles não substituem o intervalo laboratorial presente em um resultado e não são calculados por média da equipe.
