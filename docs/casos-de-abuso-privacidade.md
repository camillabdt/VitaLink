...
- o sistema permite a geração de links para compartilhamento de exames e laudos sem impor validade restrita temporal;
...
**Fluxo de abuso:**
1. O paciente gera um link de compartilhamento para um exame (A04) pelo VitaLink.
