...
A matriz cobre R01–R15 e as seis funções do NIST CSF 2.0. C03, C05, C09 e C10 se destacam pela quantidade de riscos alcançados. C01, C02 e C06, mesmo com alcance menor, ocupam posições importantes porque tratam riscos críticos e sustentam outras medidas. Esta é uma proposta inicial de ordem: a redução dos riscos só poderá ser confirmada depois da implementação, dos testes e do registro das evidências previstas.
