...
Os controles e os valores residuais apresentados são propostas e estimativas. Eles não representam mecanismos já implementados nem substituem testes e evidências técnicas.
