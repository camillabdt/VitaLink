...
Esta fatia permite ao paciente reduzir ou revogar uma autorização existente com TOTP adicional. Cada operação profissional continua autenticada pela sessão, mas consulta o estado, o escopo e o prazo atuais no PostgreSQL antes de devolver dados. Recursos clínicos ainda não implementados permanecem fora desta issue.
